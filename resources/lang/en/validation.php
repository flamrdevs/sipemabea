...
return [
    ...
    */
    ...
    'attributes' => [
        // A
        'agency' => trans('typography.agency'),
        'attachment-link' => trans('typography.attachment-file'),
        // C
        'cover-letter-link' => trans('typography.cover-letter-file'),
        ...
        // L
        'leader' => trans('typography.leader'),
        'link-facebook' => 'Facebook link',
        ...
        'person-in-charge' => trans('typography.person-in-charge'),
        'phone-number' => trans('typography.phone-number'),
        'proposal-link' => trans('typography.proposal-file'),
        // S
        'start-date' => trans('typography.start-date'),
        'status' => trans('typography.status'),
    ],
